...
const QuestSelector: React.FC<QuestSelectorProps> = ({
  selectedQuestId,
  setSelectedQuestId,
}) => {
  ...
  return (
    <FormControl fullWidth>
      <InputLabel id="demo-simple-select-label">Select Quest</InputLabel>
      <Select
        labelId="demo-simple-select-autowidth-label"
        id="demo-simple-select-autowidth"
        value={selectedQuestId}
        onChange={(e) =>
          setSelectedQuestId && setSelectedQuestId(e.target.value as string)
        }
        size="small"
        label="Age"
